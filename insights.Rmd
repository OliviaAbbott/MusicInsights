...
ratings <- tibble(time_submitted = preferences$time_submitted, psuedonym = preferences$pseudonym, artist_song = preferences$artist_song, rating = preferences$rating)
```
